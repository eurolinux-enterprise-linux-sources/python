...
# Backporting sslwrap introduces regressions so patch 221 was dropped (rhbz#1331425)
# 00222 #
...
# 00227 #
# Make load_cert_chain function of SSLContext accept a
# keyfile argument set to None
# Upstream issue: http://bugs.python.org/issue22787
...
Patch232: 00232-man-page-date-macro-removal.patch
...
Patch233: 00233-Computed-Goto-dispatch.patch

# 00234 #
# Updated implementation of PEP493
# The following features were backported:
# https://www.python.org/dev/peps/pep-0493/#feature-configuration-api
...
Patch235: 00235-JSON-decoder-lone-surrogates-fix.patch

# 0236 #
# Fix for iteration over files vith very long lines
# http://bugs.python.org/issue22526
# Resolves: rhbz#1271760
Patch236: 00236-use-Py_ssize_t-for-file-offset-and-length-computations-in-iteration.patch
...
%patch219 -p1
%patch220 -p1
# 00221: Dropped because of regressions
%patch222 -p1
%patch223 -p1
%patch224 -p1
%patch225 -p1
