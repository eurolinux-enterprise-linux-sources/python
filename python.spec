...
* Tue Aug 20 2013 Matej Stuchlik <mstuchli@redhat.com> - 2.6.6-50
- Added fix for CVE-2013-4238
Resolves: rhbz#998784

* Fri Aug 09 2013 Robert Kuska <rkuska@redhat.com> - 2.6.6-49
- Fix shebangs in several files in python-tools subpackage
Resolves: rhbz#521898
* Tue Aug 06 2013 Matej Stuchlik <mstuchli@redhat.com> - 2.6.6-48
- Fix sqlite3.Cursor.lastrowid under a Turkish locale.
Resolves: rhbz#841937
 
* Mon Jul 08 2013 Bohuslav Kabrda <bkabrda@redhat.com> - 2.6.6-47
- Urlparse now parses query and fragment of urls for any scheme.
Resolves: rhbz#978129

* Mon Jul 08 2013 Robert Kuska <rkuska@redhat.com> - 2.6.6-46
- Add wrapper for select.select to restart a system call
Resolves: rhbz#948025

* Thu Jul 04 2013 Robert Kuska <rkuska@redhat.com> - 2.6.6-45
- Add try-except to catch OSError in WatchedFileHandler
Resolves: rhbz#919163

* Thu Jul 04 2013 Robert Kuska <rkuska@redhat.com> - 2.6.6-44
- Fix urandom to throw proper exception
Resolves: rhbz#893034

* Thu Jul 04 2013 Matej Stuchlik <mstuchli@redhat.com> - 2.6.6-43
- Backport of collections.OrderedDict from Python 2.7
Resolves: rhbz#929258

* Thu Jul 04 2013 Matej Stuchlik <mstuchli@redhat.com> - 2.6.6-42
- Add an explicit RPATH to _elementtree.so pointing at the directory
containing system expat
Resolves: rhbz#962779

* Thu Jul 04 2013 Matej Stuchlik <mstuchli@redhat.com> - 2.6.6-41
- Don't let failed incoming SSL connection stay open forever
Resolves: rhbz#960168

* Thu Jul 04 2013 Matej Stuchlik <mstuchli@redhat.com> - 2.6.6-40
- Fix Python not reading Alternative Subject Names from some SSL
certificates
Resolves: rhbz#928390

* Thu Jul 04 2013 Matej Stuchlik <mstuchli@redhat.com> - 2.6.6-39
- Remove BOM insertion code from SysLogHandler that causes messages to be
treated as EMERG level
Resolves: rhbz#845802

* Fri May 10 2013 David Malcolm <dmalcolm@redhat.com> - 2.6.6-38
...
* Tue May 07 2013 Bohuslav Kabrda <bkabrda@redhat.com> - 2.6.6-37
- only call subprocess's wait with timeout kwarg when appropriate
Related: rhbz#958868

* Fri Oct 12 2012 David Malcolm <dmalcolm@redhat.com> - 2.6.6-36
...
* Thu Oct 11 2012 David Malcolm <dmalcolm@redhat.com> - 2.6.6-35
- add -DNDEBUG to OPT during the build, disabling C-level assertions
Resolves: rhbz#810847
Resolves: rhbz#841748
- avoid allocating thunks in ctypes unless absolutely necessary, to avoid
generating SELinux denials on "import ctypes" and "import uuid" when
embedding Python within httpd
Resolves: rhbz#814391
- avoid infinite loop in logging.handlers.SysLogHandler with eventlet when
the syslog daemon is stopped
Resolves: rhbz#835460

* Wed Aug 15 2012 David Malcolm <dmalcolm@redhat.com> - 2.6.6-34
...
* Tue Apr 24 2012 David Malcolm <dmalcolm@redhat.com> - 2.6.6-33
- if hash randomization is enabled, also enable it within pyexpat
Resolves: CVE-2012-0876

* Wed Mar 28 2012 David Malcolm <dmalcolm@redhat.com> - 2.6.6-32
- distutils.config: create ~/.pypirc securely
Resolves: CVE-2011-4944

* Fri Mar 23 2012 David Malcolm <dmalcolm@redhat.com> - 2.6.6-31
...
* Fri Feb 24 2012 David Malcolm <dmalcolm@redhat.com> - 2.6.6-30
